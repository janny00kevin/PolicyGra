...
mean = torch.range(1,6).reshape(3,2)
# print(mean) 
var = torch.Tensor([[0.01,0.01],[0.01,0.01],[0.01,0.01]])
a = Normal(mean, var).sample()

a = torch.range(1,15).reshape(5,3)
# print(a)
b = torch.Tensor([2, 3, 4, 5, 6])
# print(b.reshape(5,1)*a)
